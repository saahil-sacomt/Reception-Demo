...
import walletImage from '../assets/Sreenetra Final Proposal-2_page-0001.jpg';
        ...
        <div className="space-y-2">
          ...
          <div className="bg-white p-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mb-4 md:mb-0">
              <h2 className="font-normal text-[25px] text-gray-800">Welcome, User</h2>
          ...
          <div className="bg-green-50 py-10 px-5 mx-6 rounded-lg shadow flex items-center space-x-20">
            <img src={walletImage} alt="Wallet Icon" className="w-1/3 h-auto p-0 m-0" />
            <div className="text-left space-y-2">
              <h3 className="text-3xl text-gray-800">Make your first purchase</h3>
              <p className="text-sm text-gray-600 pb-4">
                Click on the button below to purchase Privilege cards.
              </p>
              <button
