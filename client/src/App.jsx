        ...
        <div className={`flex-grow transition-all duration-300 ${hideHeaderAndSidebar ? '' : isCollapsed ? 'ml-16' : 'ml-48'} min-h-screen`}>
          <Routes>
            ...
            <Route element={<RequireAuth allowedRoles={['super_admin', 'admin', 'employee']}/>}>
              ...
              <Route path="/sales-order/:orderId" element={<SalesOrderGeneration isCollapsed={isCollapsed} />} />
              <Route path="/privilege-generation" element={<PrivilegeGeneration isCollapsed={isCollapsed} />} />
              <Route path="/raise-request" element={<RaiseRequest isCollapsed={isCollapsed}/>} />
              <Route path="/admin/action-required" element={<AdminActionRequired isCollapsed={isCollapsed}/>} />
              <Route path="/modify-order/:orderId" element={<ModifyOrder />} />
              <Route path="/employee/action-required" element={<EmployeeActionRequired isCollapsed={isCollapsed}/>} />
